...
if (isset($_GET['del'])) {
    ...
    $stmt = $connection->prepare("DELETE FROM suppliers WHERE supplierID=?");
...
<div id="content" class="main-content">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Suppliers Overview</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
            <br>
            <a href="suppliersAdd.php" class="btn btn-success">Add New Supplier</a>
            <br><br>
                ...
                <div class="col-lg-12">
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <table id="suppliertable" class="table style-3 dt-table-hover">
                                <thead>
                                        ...
                                        echo '<tr>
                                                ...
                                                <td class="text-center">
                                                    <ul class="table-controls">
                                                        <li><a href="suppliersEdit.php?edit=' . $row['supplierID'] . '" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="Update" data-original-title="Update">
                                                        ...
                                                        <li>
                                                            <a href="#" class="warning confirm bs-tooltip" data-id="'.$row['supplierID'].'" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-original-title="Delete">
                                                                <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" 
    ...
    <script src="../src/plugins/src/sweetalerts2/suppliersSweetAlert.js"></script>

     <script>

        c3 = $('#suppliertable').DataTable({
