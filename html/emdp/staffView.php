...
<div id="content" class="main-content">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Staff Overview</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
            <br>
            <a href="staffAdd.php" class="btn btn-success">Add New Staff</a>
            <br><br>
                                        ...
                                        echo '<tr>
                                                ...
                                                <td class="text-center">
                                                    <ul class="table-controls">
                                                        <li><a href="staffEdit.php?edit=' . $row['userID'] . '" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="Update" data-original-title="Update">
                                                        ...
                                                        <li>
                                                            <a href="#" class="warning confirm bs-tooltip" data-id="'.$row['userID'].'" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-original-title="Delete">
                                                                <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" 
    ...
    <script src="../src/plugins/src/sweetalerts2/usersSweetAlert.js"></script>
